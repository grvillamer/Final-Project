...
def SettingsPage(page: ft.Page, user: dict, on_navigate=None, on_logout=None):
    ...
    def get_responsive_values():
        ...
        if width < 480:  # Small mobile
            ...
            # Keep content comfortably centered and compact so it still
            # looks good in a tall, narrow desktop window (like your screenshot).
            return {
                "max_width": 520,
                "padding": 24,
                "dialog_width": 420,
...
For questions about these terms, contact us at legal@smartclassroom.edu"""
    ...
    def build_settings_content():
        ...
        settings_content = ft.Column([
            ...
            # ==================== ADMIN PANEL (Admin Only, simplified) ====================
            ft.Container(
                content=ft.Column(
                    [
                        ft.Container(
                            ...
                            padding=ft.padding.symmetric(
                                ...
                                vertical=responsive["button_padding"],
                            ),
                            on_click=lambda e: on_navigate("admin")
                            if on_navigate
                            else None,
                        ),
                        ft.Divider(color=theme["border"], height=1),
                        ft.Container(
                            ...
                            padding=ft.padding.symmetric(
                                horizontal=responsive["padding"], vertical=10
                            ),
                            on_click=lambda e: on_navigate("admin")
                            if on_navigate
                            else None,
